...
from argos.slack.handlers.add_url import handle_argos_slash_command
...
from argos.slack.handlers.portfolio import handle_portfolio_mention
...
def register_handlers(app: AsyncApp) -> None:
    ...
    # /argos dispatches to the add-url flow when the text starts with `add`,
    # otherwise it falls back to the portfolio handler.
    app.command("/argos")(handle_argos_slash_command)
